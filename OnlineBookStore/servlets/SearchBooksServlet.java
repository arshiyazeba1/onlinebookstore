...
public class SearchBooksServlet extends GenericServlet{
	public void service(ServletRequest req,ServletResponse res) throws IOException,ServletException
	{
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement("Select * from " + IBookConstants.TABLE_BOOK + " where upper(" + IBookConstants.COLUMN_NAME + ") like upper(\"%" + bookName + "%\")");
